...
const Index = () => {
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="container mx-auto flex min-h-[70vh] items-center justify-center px-4 gr-section text-center animate-enter">
        <div className="max-w-2xl">
          ...
          <Link to="/post-task">
            <Button variant="hero" size="lg" className="hover-scale">Post a task</Button>
          </Link>
        </div>
      </section>
    </main>
